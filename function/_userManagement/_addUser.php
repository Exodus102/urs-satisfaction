...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        isset($_POST['first_name'], $_POST['last_name'], $_POST['campus'], $_POST['type'], $_POST['email'], $_POST['password'], $_POST['date_created']) &&
        ...
        $unit = isset($_POST['unit']) ? trim($_POST['unit']) : ''; // Unit is optional
