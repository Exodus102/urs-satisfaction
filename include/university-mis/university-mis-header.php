<header class="absolute top-0 right-0 bg-[#F1F7F9] shadow-md p-4 flex items-center w-full lg:z-50 z-0 dark:bg-gray-900 dark:text-white">
    ...
    <a href="university-mis-layout.php?page=profile" class="hidden group lg:flex place-content-end items-center space-x-2 w-1/6 rounded-lg p-1 transition-colors duration-200">
