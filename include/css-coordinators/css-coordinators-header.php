<header class="absolute top-0 right-0 bg-[#F1F7F9] shadow-md p-4 flex items-center w-full lg:z-50 z-0">
    <div class="flex items-center space-x-4 w-5/6">
        <div class="flex items-center gap-9 text-gray-500">
            ...
            <span class="lg:flex gap-2 hidden">
                ...
                ?>
                <img src="<?php echo htmlspecialchars($logo_path); ?>" alt="URSatisfaction Logo" class="w-12 h-12 object-contain">
    ...
    <a href="css-coordinators-layout.php?page=profile" class="hidden group lg:flex place-content-end items-center space-x-2 w-1/6 hover:bg-gray-100 rounded-lg p-1 transition-colors duration-200">
